  ...
  return (
    <section className="relative bg-gradient-to-br from-primary-50 via-white to-blue-50 min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-gradient-to-br from-primary-200 to-accent-200 rounded-full opacity-20 blur-3xl animate-pulse-soft"></div>
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-br from-blue-200 to-purple-200 rounded-full opacity-20 blur-3xl animate-bounce-gentle"></div>
        <div className="absolute top-1/2 right-1/3 w-48 h-48 bg-gradient-to-br from-accent-200 to-success-200 rounded-full opacity-15 blur-2xl animate-pulse-soft"></div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="relative max-w-md mx-auto">
              ...
              <div className="absolute -left-8 top-1/4 bg-white rounded-xl p-4 shadow-medium border border-gray-100 animate-float">
                <div className="flex items-center">
              ...
              <div className="absolute -right-8 bottom-1/4 bg-white rounded-xl p-4 shadow-medium border border-gray-100 animate-float" style={{animationDelay: '1s'}}>
                <div className="flex items-center">
              ...
              <div className="absolute -left-6 bottom-8 bg-white rounded-xl p-4 shadow-medium border border-gray-100 animate-float" style={{animationDelay: '2s'}}>
                <div className="flex items-center">
