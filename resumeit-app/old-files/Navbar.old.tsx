...
export default Navbar
                    ...
                    <button
                      ...
                      className="text-left text-gray-600 hover:text-primary-600 px-3 py-2 rounded-md text-base font-medium"
                    >
                      Logout
                    </button>
                  </>
                  ...
                  <>
                    <Link
                      href="/login"
                      className="text-gray-600 hover:text-primary-600 px-3 py-2 rounded-md text-base font-medium"
                      onClick={() => setIsOpen(false)}
                    >
                      Login
                    </Link>
                    <Link
                      href="/signup"
                      className="bg-primary-600 hover:bg-primary-700 text-white px-3 py-2 rounded-md text-base font-medium transition-colors text-center"
                      onClick={() => setIsOpen(false)}
                    >
                      Sign Up
                    </Link>
