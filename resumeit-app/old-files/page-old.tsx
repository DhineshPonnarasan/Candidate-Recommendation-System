...
const FeaturesPage = () => {
  ...
  const additionalFeatures = [
    ...
    },
    {
      ...
      description: 'Access opportunities worldwide with our international job matching and visa support.',
      benefits: ['200+ countries', 'Visa assistance', 'Cultural insights']
    },
    {
      icon: <RocketLaunchIcon className="w-6 h-6" />,
      title: 'Career Acceleration',
      description: 'Fast-track your career with personalized growth plans and mentorship programs.',
      benefits: ['1-on-1 mentoring', 'Growth roadmap', 'Skill tracking']
    }
  ]
  ...
  const testimonials = [
    {
      ...
      company: 'Google',
      message: 'ResumeIT helped me land my dream job at Google. The AI matching was incredibly accurate!',
      avatar: '👩‍💻'
    },
    {
      name: 'Mike Chen',
      ...
      company: 'Microsoft',
      message: 'The resume optimization tools increased my interview rate by 300%. Highly recommended!',
      avatar: '👨‍💼'
    },
    {
      name: 'Emily Davis',
      role: 'Data Scientist',
      company: 'Amazon',
      message: 'The skill assessment feature helped me identify gaps and improve my profile significantly.',
      avatar: '👩‍🔬'
    }
  ]
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              See how professionals are accelerating their careers with ResumeIT.
            </p>
          </motion.div>
